...
CASES = [
    ...
    ('stale_handoff_baseline', [('04-agentic-sdlc/README.md','runs/DOC-0.19.0/spec-manifest.json','runs/DOC-0.18.0/spec-manifest.json')], 'Current handoff baseline mismatch'),
