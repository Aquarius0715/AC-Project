...
既存のFR-C/T/AはSRC-01で整理された項目で、企業原文の逐語的な要求IDではない。企業原文との対応は[企業要望対応表](../company-requirement-map.csv)で確認する。例えば担当割当、報告承認、入金確認、FW校正・登録の詳しい手順は、企業の監視・保守という目的を実現するための設計補完を含む。
